...
const fullSizeFieldTests: testConfig[] = [
  ...
  { id: 'midfield-corner', expectedLength: 210.1338858918285 },
  {
    id: 'midfield-corner',
    ...smallerFullSizes,
    expectedLength: 167.70509831248424,
  },
  ...
  { id: 'midfield-penalty', expectedLength: 135.64014892353958 },
  {
    id: 'midfield-penalty',
    ...smallerFullSizes,
    expectedLength: 116.49892703368559,
  },
  { id: 'goal-penalty', expectedLength: 85.27602242131137 },
  {
    id: 'goal-penalty',
    ...smallerFullSizes,
    expectedLength: 85.27602242131137,
  },
  ...
  { id: 'midfield-goalbox', expectedLength: 157.98496763932954 },
  {
    id: 'midfield-goalbox',
    ...smallerFullSizes,
    expectedLength: 136.0624856453828,
  },
...
const elevenThirteenFieldTests: testConfig[] = [
  ...
  { id: 'midfield-corner', expectedLength: 145.623658792107 },
  {
    id: 'midfield-corner',
    ...smallerElevenSizes,
    expectedLength: 124.82487732819929,
  },
  ...
  { id: 'midfield-penalty', expectedLength: 94.86832980505137 },
  {
    id: 'midfield-penalty',
    ...smallerElevenSizes,
    expectedLength: 82.97590011563598,
  },
  { id: 'goal-penalty', expectedLength: 68.41052550594829 },
  {
    id: 'goal-penalty',
    ...smallerElevenSizes,
    expectedLength: 68.41052550594829,
  },
  ...
  { id: 'midfield-goalbox', expectedLength: 106.53168542738823 },
  {
    id: 'midfield-goalbox',
    ...smallerElevenSizes,
    expectedLength: 91.78235124467012,
  },
  { id: 'goal-goalbox', expectedLength: 23.430749027719962 },
  {
    id: 'goal-goalbox',
    ...smallerElevenSizes,
    expectedLength: 23.430749027719962,
  },
...
const nineTenFieldTests: testConfig[] = [
  ...
  { id: 'midfield-corner', expectedLength: 118.58541225631423 },
  {
    id: 'midfield-corner',
    ...smallerNineTenSizes,
    expectedLength: 97.78803607803972,
  },
  ...
  { id: 'midfield-penalty', expectedLength: 71.26184112131821 },
  {
    id: 'midfield-penalty',
    ...smallerNineTenSizes,
    expectedLength: 58.80688735173798,
  },
  { id: 'goal-penalty', expectedLength: 50.91168824543142 },
  {
    id: 'goal-penalty',
    ...smallerNineTenSizes,
    expectedLength: 50.91168824543142,
  },
  ...
  { id: 'midfield-goalbox', expectedLength: 86.33799858694896 },
  {
    id: 'midfield-goalbox',
    ...smallerNineTenSizes,
    expectedLength: 71.51398464636131,
  },
  { id: 'goal-goalbox', expectedLength: 16.97056274847714 },
  {
    id: 'goal-goalbox',
    ...smallerNineTenSizes,
    expectedLength: 16.97056274847714,
  },
  { id: 'penalty-kick-spot', expectedLength: 30 },
  ...
  { id: 'midfield-buildout', expectedLength: 79.89876407054116 },
  {
    ...
    ...smallerNineTenSizes,
    expectedLength: 63.236164494694016,
  },
  { id: 'goal-buildout', expectedLength: 86.91267168831021 },
  {
    id: 'goal-buildout',
    ...smallerNineTenSizes,
    expectedLength: 70.63152624713697,
  },
]

const sevenEightFieldTests: testConfig[] = [
  ...
  {
    id: 'midfield-corner',
    ...smallerEightNineFields,
    expectedLength: 43.73213921133976,
  },
  ...
  { id: 'midfield-penalty', expectedLength: 41.188590653237945 },
  {
    id: 'midfield-penalty',
    ...smallerEightNineFields,
    expectedLength: 26.580067720004024,
  },
  ...
  { id: 'goal-goalbox', expectedLength: 14.150971698084906 },
  {
    id: 'goal-goalbox',
    ...smallerEightNineFields,
    expectedLength: 14.150971698084906,
  },
